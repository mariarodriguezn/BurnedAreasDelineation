config = {
    ...
    'random_state': 44,
    'experiment_name': "39.2 Multi Unet Greece 0.3 DL_DL pretrained - CM - With TTA - With MP",
    'batch_size': 8,
    'num_epochs': 20,
    'gradient_accumulation_steps': 1,
    'additional_features': ['CM'], #NDVI #BAI #NDWI #CM
    'all_stats': {
        'spectral_bands': {
    ...
    'model_name': 'MultiTaskUNet', # MultiTaskSegformer
    ...
    'loss_func_name_ba': 'DL', 
    'loss_func_kwargs_ba':{'mode':'binary'}, # DL - 'mode':'binary'
    'loss_func_name_lc': 'DL',
    'loss_func_kwargs_lc':{'mode':'multiclass'}, # DL - 'mode':'multiclass'
    'loss_factor_lc': 0.3,
    'use_tta': True,
    'export_preds': True,
